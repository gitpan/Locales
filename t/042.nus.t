...
BEGIN {
    use_ok('Locales::DB::Language::nus');
    use_ok('Locales::DB::Territory::nus');
}

diag("Sanity checking Locales::DB::Language::nus $Locales::DB::Language::nus::VERSION DB");
...
my @my_lang_codes = sort( keys %Locales::DB::Language::nus::code_to_name );
my @my_terr_codes = sort( keys %Locales::DB::Territory::nus::code_to_name );
my %lang_lu;
my %terr_lu;
@lang_lu{@my_lang_codes} = ();
@terr_lu{@my_terr_codes} = ();
ok( $Locales::DB::Language::nus::cldr_version eq $Locales::cldr_version,       'CLDR version is correct' );
ok( $Locales::DB::Language::nus::VERSION      eq ( $Locales::VERSION - 0.12 ), 'VERSION is correct' );

ok( !( grep { !exists $lang_lu{$_} } @en_lang_codes ), 'nus languages contains en' );
ok( !( grep { !exists $terr_lu{$_} } @en_terr_codes ), 'nus territories contains en' );

my %uniq = ();
grep { not $uniq{$_}++ } @{ $Locales::DB::Language::nus::misc_info{'plural_forms'}->{'category_list'} };
is_deeply(
    [ sort @{ $Locales::DB::Language::nus::misc_info{'plural_forms'}->{'category_list'} } ],
    [ sort keys %uniq ],
    "'category_list' contains no duplicates"
);

ok( grep( m/^other$/, @{ $Locales::DB::Language::nus::misc_info{'plural_forms'}->{'category_list'} } ), "'category_list' has 'other'" );

is_deeply(
    [ grep !m/^other$/, sort @{ $Locales::DB::Language::nus::misc_info{'plural_forms'}->{'category_list'} } ],
    [ grep !m/^other$/, sort keys %{ $Locales::DB::Language::nus::misc_info{'plural_forms'}->{'category_rules'} } ],
    "'category_rules' has necessary 'category_list' items"
);

is_deeply(
    [ sort keys %{ $Locales::DB::Language::nus::misc_info{'plural_forms'}->{'category_rules'} } ],
    [ sort keys %{ $Locales::DB::Language::nus::misc_info{'plural_forms'}->{'category_rules_compiled'} } ],
