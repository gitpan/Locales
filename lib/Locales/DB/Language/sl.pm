...
$Locales::DB::Language::sl::VERSION = '0.07';
...
%Locales::DB::Language::sl::misc_info = (
    ...
    'plural_forms' => {
        ...
        'category_rules_compiled' => {
            'few' => "sub\ \{\ return\ \'few\'\ if\ \(\ \(\(\ int\(\$_\[0\]\)\ \=\=\ \$_\[0\]\ \&\&\ \(\$_\[0\]\ \%\ 100\)\ \>\=\ 3\ \&\&\ \(\$_\[0\]\ \%\ 100\)\ \<\=\ 4\ \)\)\)\;\ return\;\}\;",
            'one' => "sub\ \{\ return\ \'one\'\ if\ \(\ \(\(\ \(\$_\[0\]\ \%\ 100\)\ \=\=\ 1\)\)\)\;\ return\;\}\;",
            'two' => "sub\ \{\ return\ \'two\'\ if\ \(\ \(\(\ \(\$_\[0\]\ \%\ 100\)\ \=\=\ 2\)\)\)\;\ return\;\}\;"
        }
    },
    'posix' => {
        'nostr'  => "ne\:n",
